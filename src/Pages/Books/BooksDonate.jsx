...
import Booksimg from "./bookbox.jpg";
    ...
    <div className="BooksDonate-wrapper">
      <div className="Blood-menu-row row">
        <div className="Blood-img-col col-xl-6 col-sm-12">
          <img src={Booksimg} className="img-fluid" width="500" />
        </div>
                  ...
                  <div className="Blood-form-input-half">
                    ...
                    <div class="input-half-div input-half-div-sec w-100 mb-2">
                      ...
                      >
                        ...
                        <option value="2">Non-Fictional</option>
                        <option value="3">Academics</option>
                        <option value="3">Action</option>
                        <option value="3">Adventure</option>
                        <option value="3">Biographies</option>
                        <option value="3">Business, Economics</option>
